...
Proof.
	...
	intros. specialize H with 0 1. 
	assert (1 <= 0). apply H. repeat constructor. inversion H0.
Qed.
(** [] *)
...
Proof.
	...
	- apply Sn_le_Sm__n_le_m in H. apply Sn_le_Sm__n_le_m in H0.
		rewrite (IHa b H H0). reflexivity.
Qed.
(** [] *)
...
Theorem le_step : forall n m p,
  ...
  n <= p.
Proof.
	intros. unfold lt in H. apply Sn_le_Sm__n_le_m. apply (le_trans (S n) m).
	- assumption.
	- assumption.
Qed.
(** [] *)
...
Lemma rsc_trans :
  forall (X:Type) (R: relation X) (x y z : X),
      ...
      clos_refl_trans_1n R x z.
Proof.
	intros. induction H; subst. assumption.
...
Proof.
	...
	- induction H; subst.
		+ apply rt_refl.
		+ apply rt_step in Hxy. apply rt_trans with y; assumption.
Qed.
(** [] *)

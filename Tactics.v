...
Example injection_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  x = y.
Proof.
	intros. injection H as. symmetry in H0. rewrite <- H1 in H0. 
	injection H0 as. rewrite H. rewrite H0. reflexivity. 
Qed.
(** [] *)
...
Proof.
	...
	- destruct m. 
		+ simpl. discriminate.
		+ simpl. intros. f_equal. apply IHn'. apply H. 
Qed.
(** [] *)
...
Proof.
	...
	- intros. destruct m.
		+ discriminate.
		+ apply f_equal. simpl in H. do 2 rewrite <- plus_n_Sm in H.
			apply IHn. injection H as. apply H. 
Qed.
(** [] *)
...
Proof.
	...
	- simpl. destruct n.
		+ discriminate.
		+ intros. apply IHl. injection H as. apply H.   
Qed.
(** [] *)
...
Proof.
 	induction l.
	- intros. unfold split in H. injection H as. rewrite <- H. 
	...
	- intros. simpl in H.
	  ...
	  injection H as H1 H2. rewrite H1, H2, H0, H in *. 
...
Proof.
	...
	- destruct (f b) eqn:H2. 
		...
		+ destruct b. 
			* apply H2.
			* rewrite <- H2. f_equal. rewrite <- H1. apply H2.
	- destruct (f b) eqn:H3.
		+ destruct b.
			* rewrite <- H3. f_equal. rewrite <- H3, <- H1. reflexivity.
			* apply H3.
		+ destruct b.
			* apply H1.
			* apply H1.
...
Proof.
	intros.
	apply eq_bool in H; subst.
	apply eq_bool in H0; subst.
	induction p.
	- simpl. reflexivity.
	- simpl. apply IHp.
Qed.
...
Proof.
	...
	- discriminate.
	- discriminate.
	- simpl in H. injection H as. apply IHl1 in H. simpl. rewrite H. reflexivity.
Qed.
...
Proof.
	...
	- discriminate H.
	- destruct (test x0) eqn: tst.
		+ injection H as H1 H2. rewrite <- H1. rewrite tst. reflexivity.
		+ apply (IHl lf). rewrite H. reflexivity.
Qed.
(** [] *)

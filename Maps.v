...
Example update_example1 : examplemap' "baz"%string = false.
Proof. reflexivity. Qed.

Example update_example2 : examplemap' "foo"%string = true.
Proof. reflexivity. Qed.

Example update_example3 : examplemap' "quux"%string = false.
Proof. reflexivity. Qed.

Example update_example4 : examplemap' "bar"%string = true.
Proof. reflexivity. Qed.
...
Proof.
	...
	unfold t_update. destruct (eqb_string x y); reflexivity.
Qed.
(** [] *)
...
Proof.
	...
	destruct (string_dec x y); constructor; trivial.
Qed.
(** [] *)
...
Proof.
	...
	intro y. unfold eqb_string.
	destruct (string_dec x y); subst; reflexivity.
Qed.
(** [] *)
...
Proof.
	...
	destruct (string_dec x1 x); destruct (string_dec x2 x); subst;
	try reflexivity. contradict H. reflexivity.
Qed.
(** [] *)

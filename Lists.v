...
Fixpoint remove_all (v:nat) (s:bag) : bag :=
	match s with
	| nil => nil
	| h :: t => if eqb h v then remove_all v t
...
Proof.
  intros l. destruct l as [| h t] eqn:H.
  - (* l = nil *)
    reflexivity.
  - (* l = cons n l' *) simpl.
    reflexivity.  Qed.
...
Proof.
	intros. do 2 rewrite app_assoc. reflexivity.
Qed.
...
Proof.
	intros. simpl. destruct x. simpl. rewrite eqb_refl. reflexivity.
Qed.
(** [] *)
